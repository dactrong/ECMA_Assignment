   ...
   async render() {
    ...
    <nav id="header" class="w-full z-30 top-0 py-1">
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
            ...
            <ul class="flex">
              <li class="flex items-center"> <a href="/" class="block px-4 py-3 hover:bg-blue-800 hover:text-white" name="email" id="email"></a></li>
              <li class="flex items-center"><a class="block px-4 py-3 hover:bg-blue-800 hover:text-white" id="logout">Logout</a></li>
          </ul>
          `: ""}
                <a class="inline-block no-underline hover:text-black" href="/signin">
