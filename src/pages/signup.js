    ...
    render(){
        ...
        <div class="max-w-md w-full space-y-8">
          ...
          <form class="mt-8 space-y-6" action="#" method="POST" id ="formSignup">
            ...
            <div>
                <label for="email-address" class="sr-only">Họ và tên</label>
            ...
            <div>
                <label for="email-address" class="sr-only">Số điện thoại</label>
                <input id="phone" name="phone" type="number" autocomplete="phone" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Số điện thoại">
              </div>
            <div>
